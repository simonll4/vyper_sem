...
def loadNewBook(id: String[36], title: String[36]):
    ...
    assert book.bookTitle != empty(String[36]), "Parametros invalidos: Ingrese un titulo valido"
    assert book.bookId != empty(String[36]), "Parametros invalidos: Ingrese un ID valido"
    self.booksByTitle[book.bookTitle] = book
